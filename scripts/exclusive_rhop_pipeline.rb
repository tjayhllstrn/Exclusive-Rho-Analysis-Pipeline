...
YELLOW = "\e[1;33m"
RED    = "\e[1;31m"
# ruby exclusive_rhop_pipeline.rb --type pippi0 --input "input_hipo" --outdir "output_hipo" -n "number_entries" --config "config_file_analysis"

# ruby /w/hallb-scshelf2102/clas12/users/tjhellst/clas-ana-scaffold-tyler/scripts/run_single_hipo.rb --type pippi0 --input /lustre24/expphy/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass2/main/train/nSidis/nSidis_005032.hipo --outdir out/pippi0_fall2018_in_pass2 -n 200 --config 
