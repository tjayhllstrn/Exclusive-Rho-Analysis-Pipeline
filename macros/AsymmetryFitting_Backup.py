...
def main(inputFiles,outputDir,filename,
    ...
    if fit_type == "MLM" or fit_type == "MLMchi2":
        ...
        A_sigbkg_results,bin_centers = RunFittingMLM(obs,bin_edges,inputFiles,treeName,sigbkg_lb,sigbkg_ub,"sim") #runs "sim" or "single"
        print("\033[92mfitting bkg region\033[0m")
        A_bkg_results,bin_centers = RunFittingMLM(obs,bin_edges,inputFiles,treeName,bkg_lb,bkg_ub,"sim") #runs "sim" or "single"
